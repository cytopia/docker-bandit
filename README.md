# Docker image for `bandit`

[![Tag](https://img.shields.io/github/tag/cytopia/docker-bandit.svg)](https://github.com/cytopia/docker-bandit/releases)
[![](https://images.microbadger.com/badges/version/cytopia/bandit:latest.svg?&kill_cache=1)](https://microbadger.com/images/cytopia/bandit:latest "bandit")
[![](https://images.microbadger.com/badges/image/cytopia/bandit:latest.svg?&kill_cache=1)](https://microbadger.com/images/cytopia/bandit:latest "bandit")
[![](https://img.shields.io/docker/pulls/cytopia/bandit.svg)](https://hub.docker.com/r/cytopia/bandit)
[![](https://img.shields.io/badge/github-cytopia%2Fdocker--bandit-red.svg)](https://github.com/cytopia/docker-bandit "github.com/cytopia/docker-bandit")
[![License](https://img.shields.io/badge/license-MIT-%233DA639.svg)](https://opensource.org/licenses/MIT)

[![lint](https://github.com/cytopia/docker-bandit/workflows/lint/badge.svg)](https://github.com/cytopia/docker-bandit/actions?query=workflow%3Alint)
...
View **[Dockerfile](https://github.com/cytopia/docker-bandit/blob/master/Dockerfile)** on GitHub.

[![Docker hub](http://dockeri.co/image/cytopia/bandit?&kill_cache=1)](https://hub.docker.com/r/cytopia/bandit)

Tiny Alpine-based multistage-build dockerized version of [bandit](https://github.com/PyCQA/bandit)<sup>[1]</sup>.
The image is built nightly against multiple stable versions and pushed to Dockerhub.

<sup>[1] Official project: https://github.com/PyCQA/bandit</sup>
...
|------------|------------|
| `latest`   | Latest stable bandit version |
...
# Windows (cmd)
docker run --rm -v %cd%:/data cytopia/bandit -r /data
```
